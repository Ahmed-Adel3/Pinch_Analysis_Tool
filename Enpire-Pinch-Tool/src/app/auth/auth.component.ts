...
export class AuthComponent implements OnInit {
    ...
    constructor(
        ...
        private gc: GlobalSettingsService,
        private ELData: ExternalLoginService
    ...
    ngOnInit() {
        ...
        this._router.navigate([this.gc.frontStatus()]);
        ...
        this._userService.create(this.model).subscribe(
            data => {
                ...
                this._alertService.success(
                    'Thank you. Please check your e-mail and follow the instructions to activate your account',
                    true);
                this.loading = false;
            ...
            error => {
                ...
                errorMessage = errorMessage.substring(2, errorMessage.length - 1)
    ...
    getLinkedinData() {
        const service = this.ELData.getExternalLoginData();
        service.subscribe()
    }
}